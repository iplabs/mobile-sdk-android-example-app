...
val thirdPartyComponentLicenseInventory = listOf(
	...
	ThirdPartyComponentLicense(
		...
		licenseFile = R.raw.license_androidx_appcompat_appcompat,
		componentName = "Android AppCompat Library",
		componentVersion = "1.6.1",
		componentVendor = "Google LLC",
		componentLink = "https://developer.android.com/jetpack/androidx/releases/appcompat/"
	),
	ThirdPartyComponentLicense(
		licenseName = "Apache License, Version 2.0",
		licenseFile = R.raw.license_androidx_constraintlayout_constraintlayout,
		componentName = "Android ConstraintLayout Library",
		componentVersion = "2.1.4",
		componentVendor = "Google LLC",
		componentLink = "https://developer.android.com/jetpack/androidx/releases/constraintlayout/"
	),
	ThirdPartyComponentLicense(
		licenseName = "Apache License, Version 2.0",
	...
	ThirdPartyComponentLicense(
		...
		componentVendor = "Google LLC",
		componentLink = "https://github.com/google/material-design-icons/"
	),
	ThirdPartyComponentLicense(
		licenseName = "Apache License, Version 2.0",
